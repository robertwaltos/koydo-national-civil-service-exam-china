...
const EXAM_ID = "national-civil-service-exam-china";
const EXAM_DISPLAY_NAME = "国家公务员考试 (National Civil Service Exam — China)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. 请用中文回答所有问题。

覆盖《行政职业能力测验》（行测：言语理解、数量关系、判断推理、资料分析、常识判断）和《申论》（概括归纳、综合分析、提出对策、文章写作）。遵循国家公务员局考试大纲。
